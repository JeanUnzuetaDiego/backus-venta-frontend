...
export class SameStoreSalesService {
  ...
  public configurationVariationByChain(startDate?: string, endDate?: string, filterMenu?: any, typeFilter?: string, sssFilter?: string): Promise<any[]> {
    const params: any = {
      startDate, endDate, filterMenu, typeFilter, sssFilter
    };

    const obs$ = this.http.get<any[]>(`${environment.backendUrl}/api/v1/sales/variation-by-chain`, { params });
    return firstValueFrom(obs$);
  }

  public processDataSSSGraphicMonth(startDate?: string, endDate?: string, filterMenu?: any, typeFilter?: string, sssFilter?: string): Promise<any[]> {
    const params: any = {
      startDate, endDate, filterMenu, typeFilter, sssFilter
    };
  ...
  public configurationDataAutogestion(startDate?: string, endDate?: string, columns?: string): Promise<any[]> {
    const params: any = {
